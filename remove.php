<?php 
	...
	if (isset($_POST['remove'])) {
		$qtyadd = $_SESSION['totalQuantity']-$arrCartDelete[$_GET['deleteID']]['quantity'];
		$_SESSION['totalQuantity'] = $qtyadd;
...
<head>
    ...
    <title>Learn IT Easy Online Shop | Removed</title>
</head>
<body>
<div class="container">
    <form method="post">	
            ...
            <div class="col-md-4 col-sm-6">
                <div class="product-grid2">
                    <div class="product-image2">
                            ...
                            <img class="pic-1" height="60%" src="IMG/<?php echo $arrCartDelete[$keyID]['product'];?>">
                            <img class="pic-2" height="60%" src="IMG/<?php echo $arrCartDelete[$keyID]['product2'];?>">
                    </div>
                </div>
            </div>
            <div class="col-md-8 col-sm-6">
                 <!-- display product name and price -->
                <h3><?php echo $arrCartDelete[$keyID]['name'];?> <span class="pricebg"><?php echo " ₱ ".$arrCartDelete[$keyID]['product_price'];?></span></h3>
